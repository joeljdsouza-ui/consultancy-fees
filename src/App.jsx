...
const services = [
  ...
  { category: "Creator & Influencer Engagement", icon: "🤝", description: "Genuine relationships with voices your ICP already trusts.", items: [{ name: "Creator mapping & outreach strategy", oneTime: true, price: "₹20,000 (one-time)" },{ name: "Ongoing creator relationship management (10–15)", price: "₹20,000/month" },{ name: "Co-creation coordination (joint posts, webinar guests)", price: "₹10,000/collaboration" }]},
  { category: "GenZ Communications Layer", icon: "⚡", description: "The strategic overlay that makes everything above land with India's dominant emerging audience.", items: [{ name: "GenZ brand audit (comms, content, employer brand)", oneTime: true, price: "₹30,000–50,000 (one-time)" },{ name: "GenZ employer brand content strategy", oneTime: true, price: "₹40,000–60,000 (one-time)" },{ name: "GenZ GTM communication workshop (founder/team)", oneTime: true, price: "₹25,000–40,000/session" },{ name: "Ongoing GenZ comms advisory", price: "Included in all slabs" }]},
];
        ...
        {activeTab===2&&(
          <div>
            ...
            {[
              ...
              { area:"Content Production Engine", icon:"⚙️", color:"border-blue-700", accent:"text-blue-400", what:"A weekly system that produces consistent, high-quality output without monopolising the founder's calendar.", deliverables:["Weekly content call (30–60 min extract → 3–5 posts)","Blog posts and briefs","Carousel copy + design briefs","Video scripts","Content repurposing across formats"], outcome:"Consistent 3–5x/week publishing cadence. Content library builds over time and keeps selling when no one is in the room." },
              { area:"Community Building", icon:"🏘️", color:"border-green-700", accent:"text-green-400", what:"Building an active community of buyers, advocates, and champions around the brand.", deliverables:["LinkedIn group setup and moderation","WhatsApp/Discord community management","Champion identification and activation","Monthly champion comms (email/update)","UGC monitoring and amplification"], outcome:"Brand has an owned audience that creates content, refers clients, and validates the product socially." },
              ...
              { area:"GenZ Communications Layer", icon:"⚡", color:"border-orange-700", accent:"text-orange-400", what:"The strategic overlay applied to all of the above. Making everything land with India's most important emerging audience.", deliverables:["GenZ brand audit","Employer brand content for GenZ talent acquisition","GenZ GTM communication workshop","Platform-native content strategy (LinkedIn, Reels, Shorts)","GenZ-specific messaging for product and hiring"], outcome:"Brand becomes legible, credible, and compelling to the generation reshaping Indian business — as buyers, as talent, and as advocates." },
            ].map(s=>(
